                ...
                <div className="crypto__grid__lg">
                    <Card className="crypto_news-card">
                        <div className="crypto__card__title">
                            <h5>
                                What next for French victims of the FTX
                                cryptocurrency exchange collapse?
                            </h5>
                            <CryptoNewsImg />
                        </div>
                        <p>
                            The collapse of the FTX cryptocurrency exchange has
                            had repercussions around the globe, with more than a
                            million clients losing money overni...
                        </p>
